...
public class TopicDaoImp implements TopicDao {
    ...
    public void addTopic(Topic topic) {
       ...
       Connection con = null;
        try {
            ...
            System.out.println("addTopic Connection açıldı");
            ...
            try {
                if (con != null) {
                    con.close();
                    System.out.println("addTopic Connection kapandı");
                }
            } catch (Exception e){ System.out.println(e);}
        }
        }else{
    ...
    public Topic getTopic(int id) {
        ...
        try {
            ...
            con = DriverManager.getConnection(sqlConfig.url, sqlConfig.user, sqlConfig.password);
            System.out.println("getTopic Connection açıldı");
            ...
            try {
                if (con != null) {
                    con.close();
                    System.out.println("getTopic Connection kapandı");
                }
            } catch (Exception e){ System.out.println(e);}
        }
    ...
    public ArrayList<Models.Topic> getAllTopics() {
        ...
        try {
            ...
            con = DriverManager.getConnection(sqlConfig.url, sqlConfig.user, sqlConfig.password);
            System.out.println("getAllTopics Connection açıldı");
            ...
            try {
                if (con != null) {
                    con.close();
                    System.out.println("getAllTopics Connection kapandı");
                }
            } catch (Exception e){ System.out.println(e);}
        }
    ...
    public boolean updateTopicTitle(Topic topic) {
        ...
        try {
            ...
            con = DriverManager.getConnection(sqlConfig.url, sqlConfig.user, sqlConfig.password);
            System.out.println("updateTopicTitle Connection açıldı");
            ...
            try {
                if (con != null) {
                    con.close();
                    System.out.println("updateTopicTitle Connection kapandı");
                }
            } catch (Exception e){ System.out.println(e);}
        }
        }else{
    ...
    public boolean updateTopicContent(Topic topic) {
        ...
        try {
            ...
            con = DriverManager.getConnection(sqlConfig.url, sqlConfig.user, sqlConfig.password);
            System.out.println("updateTopicContent Connection açıldı");
            ...
            try {
                if (con != null) {
                    con.close();
                    System.out.println("updateTopicContent Connection kapandı");
                }
            } catch (Exception e){ System.out.println(e);}
        }
         }else{
    ...
    public void deleteTopic(int id) {
        ...
        try {
            ...
            con = DriverManager.getConnection(sqlConfig.url, sqlConfig.user, sqlConfig.password);
            System.out.println("deleteTopic Connection açıldı");
