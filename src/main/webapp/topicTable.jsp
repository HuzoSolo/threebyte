            ...
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr onclick="redirectToSpecificLink('topic.jsp?id=<%= topics.get(i).getId()%>&title=<%= topics.get(i).getTitle()%>')">
                                ...
                                <div class="row" style="height: 6rem;">
                                    ...
                                    <div class="col-sm-12 col-xl-11">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <p class="card-text ps-4">by <% out.println(topics.get(i).getUserId()); %></p>
                                                </div>
                                                <div class="col">
